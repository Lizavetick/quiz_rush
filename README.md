# quiz_rush
The quiz_rush game is a network quiz in which several players connect to a shared server and compete in the correctness and speed of answering questions. 

The game is written in C using TCP sockets and poll().
